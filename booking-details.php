...
<head>
  <title>Event Management System || Booking Status</title>
  <meta charset="utf-8">
       ...
       <tr>
                 ...
                 <tr>
                  <th>Posting Date</th>
                    ...
                    <th>Event Name</th>
                    <td ><?php echo $result['BoatName']?>  <a href='evdetails.php?bid=<?php echo $result['BoatID']; ?>' target="blank"> View Details</a></td>
                  </tr>
            <tr>
...
<span class="badge bg-warning text-dark">Not Processed Yet</span>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/ho1.jpg');">
      <div class="container">
