...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <div class="intro-section" style="background-image: url('images/ho4.jpg');">
        <div class="container">
...
?>
        <div class="row">
          ...
          <div class="col-md-5">
            ...
            <h3 class="heading-92913 text-black">Event Details</h3>
              ...
              <div class="form-group col-md-12">
                ...
                <a href="bookev.php?bid=<?php echo $result['ID']; ?>"  class="btn btn-primary py-3 px-5">
                 Book Now</a>
              </div>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/ho4.jpg');">
      <div class="container">
