...
<head>
  ...
  <title>Event Management System  | Update Event</title>
...
<div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" name="description" placeholder="Enter Description of Event" required><?php echo $result['Description'];?></textarea>
                  </div>
<?php } ?>
