...
if($query){
echo '<script>alert("Your Event booking request has been sent successfully. Booking number is "+"'.$bno.'")</script>';
...
echo "<script>alert('Event not available for these dates. Please select the diffrent dates');</script>";
}}
...
<head>
  <title>Event Management System || Booking Page</title>
  <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <p><img src="images/ho1.jpg" alt="Image" class="img-fluid"></p>
          </div>
          <div class="col-md-6">
            <span class="text-serif text-primary">Book Now</span>
            <h3 class="heading-92913 text-black">Book Event</h3>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/hm4.jpg');">
      <div class="container">
